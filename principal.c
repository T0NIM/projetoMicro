...
void init_PWM(void) {
    TRISC2 = 0;          // RC2 (CCP1) como sa�da
    PR2 = 255;           // Define per�odo PWM (5kHz para Fosc = 8MHz e prescaler 4)
...
const char digits[10] = { // Tabela que decodifica os segmentos dos displays em digitos compreens�veis
    0b00111111, // 0
    0b00000110, // 1
    0b01011011, // 2
    0b01001111, // 3
